...
//         table_slider_login.window = window.open(url, 'newWindowName', 'width=430,height=932');
//         if (table_slider_login.window) {
//             table_slider_login.window.focus();
//         } else {
//             console.error('无法打开新窗口，请检查弹出窗口设置.');
//         }
//     },
//     close: () => {
//     },
